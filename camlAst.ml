...
let patt_of_string      _loc = parse_string Syntax.patt      <:patt<()>>   _loc
let sig_items_of_string _loc = parse_string Syntax.sig_items <:sig_item<>> _loc
let str_items_of_string _loc = parse_string Syntax.str_items <:str_item<>> _loc
